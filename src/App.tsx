  ...
  return (
    <section className="relative w-full min-h-screen overflow-hidden bg-[#0a1517]">
      ...
      <div className="relative z-[2] flex flex-col min-h-screen pb-8 px-6 sm:px-12 pt-24">
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.4 }} className="mt-auto pt-8 flex flex-wrap justify-center gap-x-6 gap-y-2 text-[#DEF2F1]/55 text-xs sm:text-sm font-sans">
